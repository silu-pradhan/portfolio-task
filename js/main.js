(function () {
  ...
  const skillDescriptions = {
    ...
    "Responsive Design": "Layouts that adapt cleanly across mobile, tablet, and desktop devices.",
    "UI Animation": "Motion that supports hierarchy, feedback, and a more premium feel.",
    "Figma to Code": "Translating design systems into structured front-end implementation.",
    ...
    "Performance Optimization": "Improving loading, interaction quality, and overall user experience."
  };
  const skillIcons = {
    "HTML5": "html",
    "CSS3": "css",
    ...
    skillsGrid.innerHTML = skills.map((skill, index) => `
      <article class="skill-card reveal">
        ...
        <div class="skill-copy">
          ...
          <p>${escapeHtml(skillDescriptions[skill] || "Strong practical knowledge applied across real web projects and interface work.")}</p>
        </div>
      </article>
    `).join("");
